...
# === PATHS DOS ARQUIVOS ===
DATA_RAW = "../data/leiteintel_base_ampliada.csv"
DATA_CLEAN = "../data/processed/leiteintel_base_limpa.csv"
...
# === CARREGAR BASE ===
if not os.path.exists(DATA_CLEAN):
    st.error(f"Arquivo limpo não encontrado e não foi possível gerar a base limpa.\nVerifique se '{DATA_RAW}' existe.")
    st.stop()
